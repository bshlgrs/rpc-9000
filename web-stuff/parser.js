...
yy: {},
symbols_: {"error":2,"program":3,"function":4,"EOF":5,"INT":6,"NAME":7,"(":8,"listOfArgs":9,"{":10,"body":11,"}":12,"arg":13,")":14,",":15,"stat":16,"type":17,"=":18,"expr":19,";":20,"RETURN":21,"+":22,"-":23,"*":24,"/":25,"NUMBER":26,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"INT",7:"NAME",8:"(",10:"{",12:"}",14:")",15:",",18:"=",20:";",21:"RETURN",22:"+",23:"-",24:"*",25:"/",26:"NUMBER"},
productions_: [0,[3,2],[4,7],[9,2],[9,3],[11,2],[11,1],[13,2],[17,1],[16,4],[16,2],[16,3],[19,3],[19,3],[19,3],[19,3],[19,2],[19,3],[19,1],[19,1]],
...
case 1:return $$[$0-1];
break;
case 2:this.$ = ["FunctionDef", $$[$0-5], $$[$0-3], $$[$0-1]];
break;
case 3:this.$ = [$$[$0-1]];
break;
...
case 8:this.$ = ["Int"];
break;
case 9:this.$ = ["Assignment", $$[$0-3], $$[$0-1]];
break;
case 10:this.$ = ["Return"];
break;
case 11:this.$ = ["Return", $$[$0-1]];
break;
case 12:this.$ = ["BinOp", "+", $$[$0-2], $$[$0]];
break;
case 13:this.$ = ["BinOp", "-", $$[$0-2], $$[$0]];
break;
case 14:this.$ = ["BinOp", "*", $$[$0-2], $$[$0]];;
break;
case 15:this.$ = ["BinOp", "/", $$[$0-2], $$[$0]];
break;
case 16:this.$ = ["BinOp", "-", ["IntLit", 0], $$[$01]];
break;
case 17:this.$ = $$[$0-1];
break;
case 18:this.$ = ["Var", $$[$0]];
break;
case 19:this.$ = ["IntLit", Number(yytext)];
break;
}
},
table: [{3:1,4:2,6:[1,3]},{1:[3]},{5:[1,4]},{7:[1,5]},{1:[2,1]},{8:[1,6]},{6:[1,10],9:7,13:8,17:9},{10:[1,11]},{14:[1,12],15:[1,13]},{7:[1,14]},{7:[2,8]},{7:[1,17],11:15,16:16,21:[1,18]},{10:[2,3]},{6:[1,10],9:19,13:8,17:9},{14:[2,7],15:[2,7]},{12:[1,20]},{7:[1,17],11:21,12:[2,6],16:16,21:[1,18]},{18:[1,22]},{7:[1,27],8:[1,26],19:24,20:[1,23],23:[1,25],26:[1,28]},{10:[2,4]},{5:[2,2]},{12:[2,5]},{7:[1,27],8:[1,26],19:29,23:[1,25],26:[1,28]},{7:[2,10],12:[2,10],21:[2,10]},{20:[1,30],22:[1,31],23:[1,32],24:[1,33],25:[1,34]},{7:[1,27],8:[1,26],19:35,23:[1,25],26:[1,28]},{7:[1,27],8:[1,26],19:36,23:[1,25],26:[1,28]},{14:[2,18],20:[2,18],22:[2,18],23:[2,18],24:[2,18],25:[2,18]},{14:[2,19],20:[2,19],22:[2,19],23:[2,19],24:[2,19],25:[2,19]},{20:[1,37],22:[1,31],23:[1,32],24:[1,33],25:[1,34]},{7:[2,11],12:[2,11],21:[2,11]},{7:[1,27],8:[1,26],19:38,23:[1,25],26:[1,28]},{7:[1,27],8:[1,26],19:39,23:[1,25],26:[1,28]},{7:[1,27],8:[1,26],19:40,23:[1,25],26:[1,28]},{7:[1,27],8:[1,26],19:41,23:[1,25],26:[1,28]},{14:[2,16],20:[2,16],22:[2,16],23:[2,16],24:[2,16],25:[2,16]},{14:[1,42],22:[1,31],23:[1,32],24:[1,33],25:[1,34]},{7:[2,9],12:[2,9],21:[2,9]},{14:[2,12],20:[2,12],22:[2,12],23:[2,12],24:[1,33],25:[1,34]},{14:[2,13],20:[2,13],22:[2,13],23:[2,13],24:[1,33],25:[1,34]},{14:[2,14],20:[2,14],22:[2,14],23:[2,14],24:[2,14],25:[2,14]},{14:[2,15],20:[2,15],22:[2,15],23:[2,15],24:[2,15],25:[2,15]},{14:[2,17],20:[2,17],22:[2,17],23:[2,17],24:[2,17],25:[2,17]}],
defaultActions: {4:[2,1],10:[2,8],12:[2,3],19:[2,4],20:[2,2],21:[2,5]},
...
rules: [/^(?:\s+)/,/^(?:[0-9]+?\b)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:=)/,/^(?:;)/,/^(?:int\b)/,/^(?:void\b)/,/^(?:return\b)/,/^(?:\{)/,/^(?:\})/,/^(?:,)/,/^(?:$)/,/^(?:[a-zA-Z_]+)/,/^(?:.)/],
